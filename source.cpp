...
void Pendule::evolution(bool dO1cst = false, bool do2cst = false){ //Implémentation de la méthode RK4, c'est la partie fun du projet, le reste sera plus tranquille
...
void Pendule::affichage(showgraph = false){ //cette fonction execute le script gnuplot pour faire un graphe
